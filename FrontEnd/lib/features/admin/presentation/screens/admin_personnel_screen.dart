...
class _AdminPersonnelScreenState
  ...
  final List<String> _roles = [
    'Tous', 'medecin', 'infirmier',
    'accueil', 'laborantin', 'pharmacien', 'admin',
  ];
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (!mounted) { return; }
      setState(() { _tous = p; _loading = false; });
      _applyFilters();
    } catch (e) {
      if (!mounted) { return; }
      setState(() {
    ...
    setState(() {
      _filtered = _tous.where((p) {
        ...
        final matchSearch = _searchQuery.isEmpty ||
            p.nomComplet.toLowerCase().contains(
                _searchQuery.toLowerCase()) ||
            p.identifiantPro.toLowerCase().contains(
                _searchQuery.toLowerCase());
  ...
  Color _roleColor(String role) {
    switch (role) {
      case 'medecin':    return const Color(0xFF1565C0);
      case 'infirmier':  return const Color(0xFF2E7D32);
      case 'accueil':    return const Color(0xFF0277BD);
      case 'laborantin': return const Color(0xFFE65100);
      case 'pharmacien': return const Color(0xFFAD1457);
  ...
  Color _roleBg(String role) {
    switch (role) {
      case 'medecin':    return const Color(0xFFE3F2FD);
      case 'infirmier':  return const Color(0xFFE8F5E9);
      case 'accueil':    return const Color(0xFFE1F5FE);
      case 'laborantin': return const Color(0xFFFFF3E0);
      case 'pharmacien': return const Color(0xFFFCE4EC);
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '@${personnel.identifiantPro} · ${personnel.hopital}',
                  style: const TextStyle(
                    fontSize: 11,
                    color: AppColors.textMedium,
                  ),
